...
-   **Hub staff permission is required to roleplay certain important lore characters, e.g., Clipped Council members. Generally, if you'd need staff permission to roleplay a character on Lux, you need hub staff permission to do it on the hub too.**
-   **Character abilities, equipment and resources should be ICly justified and preferably balanced, with sensible weaknesses.** Don't just make a billionaire character willy-nilly. Roleplayers who make overpowered or "gamey" characters will have a chat with hub staff first (and Lux staff will be informed if it's also happening on Lux).
-   **If you are violating rules, hub staff may require your character to "take an L", force CRP consent, allow others to void you without consequence or ban your character from the hub, etc., depending on the severity of the violation. If violations are bad enough, you may be banned from RPing on the hub and Lux staff may be warned about you. Rule violations done out of OOC spite will receive more stringent punishment.** IC explanation for punishment consequences is generally left to the punished roleplayer, if hub staff do not provide it.
